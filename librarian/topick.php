  ...
  <body>
    ...
    <div class="page-content">
        ...
        <?php
          ...
          $sqlget = "SELECT * FROM borrow where borrow_date = '$todaydate'";
          $result = $conn->query($sqlget);


          if ($result->num_rows > 0) {

            echo "<table class='table table-striped'><tr><th>User Name</th><th>Book Name</th><th>Bill Price</th><th>Bill Status </th></tr>";
              ...
              while($row = $result->fetch_assoc()) {
                  ...
                  echo "<tr><td>".$row2["user_name"]."</td><td>".$row["borrow_book_name"]."</td><td>".$row["book_price"]."</td><td>".$row2["bill_status"];
              }
              echo "</table>";
          } else {
              echo "0 results";
