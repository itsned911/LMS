    ...
    <div class="page-content">
        ...
        <?php
          ...
          if ($result->num_rows > 0) {
            echo "<table class='table table-striped'><tr><th>Name</th><th>Delete</th></tr>";
              // output data of each row
              while($row = $result->fetch_assoc()) {
				  $cat_id = $row["cat_id"];
                  echo "<tr><td>".$row["cat_name"]."</td><td>";
				  ?>
				  
				  <a href="deletecat.php?id=<?php echo $cat_id;?>"><button name='' class='btn btn-danger btn-xs'><span class='glyphicon glyphicon-trash'></span></button></a>
