  ...
  <body>
    ...
    <div class="page-content">
        ...
        <?php
          ...
          $sqlget = "SELECT users.id,name,email,user_type FROM users inner join type on users.role_id = type.id";
          ...
          if ($result->num_rows > 0) {
            echo "<table class='table table-striped'><tr><th>UserName</th><th>Email</th><th>Role Type</th><th>Delete</th></tr>";
              // output data of each row
              while($row = $result->fetch_assoc()) {
				  $id = $row["id"];
                  echo "<tr><td>".$row["name"]."</td><td>".$row["email"]."</td><td>".$row["user_type"]."</td><td>";
				  echo $id;
				  
                   ?>
				  <a href="deleteuser.php?id=<?php echo $id;?>"><button class='btn btn-danger btn-xs'><span class='glyphicon glyphicon-trash'></span></button></a>
